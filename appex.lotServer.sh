...
URLKernel='https://raw.githubusercontent.com/bczol/serverSpeeder_kernel/master/serverSpeeder.txt'
...
wget --no-check-certificate -q -O "/root/appex/apxfiles/bin/acce-"$KNV"-["$KNA"_"$KNN"_"$KNK"]" "https://raw.githubusercontent.com/bczol/serverSpeeder_kernel/master/$MyKernel"
...
wget --no-check-certificate -q -O "/appex/etc/apx.lic" "https://go-speedup.com/lotserver/keygen.php?ver=0&mac=$MAC"
...
{
[ ! -f /root/appex.zip ] && wget --no-check-certificate -q -O "/root/appex.zip" "https://raw.githubusercontent.com/bczol/serverSpeeser_Install/master/appex.zip"
